      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
          <ScrollReveal delay={0.1}>
            <ContactLink href="mailto:kizmojk@gmail.com" label="Email">
              <svg
                width="18"
                height="18"
                viewBox="0 0 24 24"
          ...
          <ScrollReveal delay={0.2}>
            <ContactLink href="tel:+639480734052" label="Phone">
              <svg
                width="18"
                height="18"
                viewBox="0 0 24 24"
          ...
          <ScrollReveal delay={0.3}>
            <ContactLink href="https://www.linkedin.com/in/julius-kevin-alejandro/" label="LinkedIn" display="Connect with me">
              <svg
                width="18"
                height="18"
                viewBox="0 0 24 24"
